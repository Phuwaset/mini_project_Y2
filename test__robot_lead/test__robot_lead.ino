...
Servo servo1;  // เซอร์โวตัวที่ 1 (น่าจะเป็นฐานหมุน) 25
Servo servo2;  // เซอร์โวตัวที่ 2 (น่าจะเป็นข้อต่อแขนด้านล่าง) 33 
Servo servo3;  // เซอร์โวตัวที่ 3 (น่าจะเป็นข้อต่อแขนด้านบน) 32
